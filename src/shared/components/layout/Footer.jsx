...
export default function Footer() {
  return (
    <footer id="footer-section" className="bg-[#040e1c] text-slate-300 text-xs border-t border-cyan-500/20">
      {/* Top Banner Feature Bar */}
      <div className="bg-[#071b34] py-8 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-cyan-400/20 text-cyan-400 flex items-center justify-center shrink-0">
      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-cyan-600 flex items-center justify-center text-[#071b34] font-black text-lg shadow-md">
                HN
              </div>
              <div>
            ...
            <div className="p-3 bg-[#071b34] rounded-2xl border border-cyan-400/20 space-y-1 text-[11px]">
              <div className="text-cyan-300 font-bold">Người sáng lập & Điều hành:</div>
          ...
          <div className="lg:col-span-3 space-y-3">
            <h4 className="font-extrabold text-white text-sm uppercase tracking-wider text-cyan-400">
              Dịch Vụ Đồng Phục
            </h4>
            <ul className="space-y-2 text-slate-400">
              <li>
                <a href="#catalog-section" className="hover:text-cyan-300 transition-colors flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-2.5 pt-1">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-cyan-400 font-extrabold text-sm hover:underline"
                  >

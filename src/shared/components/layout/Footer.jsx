      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              {/* Footer logo — TRÒN */}
              <div className="relative w-11 h-11 rounded-full aspect-square overflow-hidden border-2 border-amber-400/60 shadow-md bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center">
                <span className="absolute font-black text-base text-[#071b34]">HN</span>

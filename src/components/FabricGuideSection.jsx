...
import { FABRIC_COMPARISONS } from "@/data/products";
    ...
    <section id="fabric-guide-section" className="py-16 bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-amber-500/10 via-amber-400/20 to-amber-500/10 p-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-amber-300/40">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-amber-500 text-[#071b34] flex items-center justify-center font-bold shadow-md shrink-0">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#071b34] hover:bg-slate-800 text-amber-300 font-bold text-xs sm:text-sm rounded-xl shadow-lg transition-all shrink-0 flex items-center gap-2"
            >

      ...
      <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200 animate-in fade-in zoom-in-95">
        ...
        <div className="bg-[#071b34] text-white p-5 flex items-center justify-between border-b border-amber-500/20">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-amber-200/80">HDC GROUP VN • Xưởng Sản Xuất Trực Tiếp</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        {step === 1 ? (
          <form onSubmit={handleSubmitOrder} className="p-6 max-h-[85vh] overflow-y-auto space-y-6">
            ...
            <div>
              ...
              {(paymentMethod === "vietqr" || paymentMethod === "deposit30") && (
                <div className="p-4 bg-slate-900 text-white rounded-2xl border border-amber-500/40 flex flex-col sm:flex-row items-center gap-5">
                  ...
                  <div className="space-y-1.5 text-xs flex-1">
                    ...
                    <div className="text-[11px] text-slate-400 pt-1">
                      Nội dung CK: <strong className="text-amber-300">HUNI {phone || "DONHANG"}</strong>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="pt-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <button
                type="submit"
                className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:to-amber-500 text-[#071b34] font-black text-sm rounded-2xl shadow-xl flex items-center justify-center gap-2"
              >
          ...
          <div className="p-8 text-center space-y-5">
            ...
            {placedOrder && (
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 max-w-md mx-auto text-left text-xs space-y-1.5">
                <div className="flex justify-between">
                  <span className="text-slate-500">Mã đơn hàng:</span>
                  <strong className="text-amber-900 font-black text-sm">{placedOrder.id}</strong>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <strong className="text-amber-800 font-bold">{placedOrder.total.toLocaleString("vi-VN")} đ</strong>
                </div>
                <div className="flex justify-between pt-1 border-t border-amber-200 text-slate-700">
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              <button
                onClick={handleClose}
                className="px-6 py-2.5 bg-[#071b34] text-amber-300 font-bold text-xs rounded-xl shadow"
              >

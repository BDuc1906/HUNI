      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="pt-4 border-t border-slate-800 flex items-center gap-4 text-xs text-amber-400">
              <a
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#0b2042] rounded-3xl border border-amber-400/30 p-6 sm:p-8 shadow-2xl">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`p-2.5 rounded-xl border text-center font-bold transition-all ${
                            category === item.id
                              ? "bg-amber-500 text-[#071b34] border-amber-400 shadow-md"
                  ...
                  <div>
                    <div className="flex items-center justify-between text-xs font-bold mb-2">
                      <span className="text-amber-300">2. Số Lượng Áo Dự Kiến:</span>
                      <span className="text-base text-amber-400 font-black">{quantity} sản phẩm</span>
                    </div>
                    <input
                      type="range"
                      min="10"
                  ...
                  <div className="p-4 bg-gradient-to-r from-[#071b34] to-[#040e1c] rounded-2xl border border-amber-500/40 flex items-center justify-between">
                    <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-400"
                      />
                    </div>
                    <div>
                      <label className="font-bold text-slate-200 block mb-1">
                        Số Điện Thoại / Zalo Nhận Báo Giá <span className="text-amber-400">*</span>:
                      </label>
                      <input
                        type="tel"
                        required
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:to-amber-500 text-[#071b34] font-black text-sm rounded-2xl shadow-xl flex items-center justify-center gap-2 transform hover:-translate-y-0.5 transition-all"
                  >
                ...
                <div className="text-center py-10 space-y-4">
                  <div className="w-16 h-16 rounded-full bg-amber-400/20 text-amber-400 flex items-center justify-center mx-auto">
                  ...
                  <p className="text-sm text-slate-300 max-w-md mx-auto">
                    ...
                    <strong className="text-amber-300">{phone}</strong> trong vòng 5 - 10 phút.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    className="px-5 py-2.5 bg-slate-800 text-amber-400 rounded-xl text-xs font-bold hover:bg-slate-700"
                  >

...
export default function CeoLetterSection() {
  ...
  return (
    <section id="ceo-letter-section" className="py-20 bg-gradient-to-b from-[#071b34] to-[#040e1c] text-white relative overflow-hidden border-t border-b border-cyan-500/20">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
          <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-cyan-400/10 border border-cyan-400/30 text-cyan-300 text-xs font-bold uppercase tracking-wider">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-cyan-600 mx-auto rounded-full mt-2" />
        </div>

        {/* Main Content Card with Golden Border */}
        <div className="bg-[#0b2042]/90 backdrop-blur-md rounded-3xl border border-cyan-400/30 p-6 sm:p-10 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            {/* Left: CEO Portrait Card */}
            <div className="lg:col-span-5 flex flex-col items-center text-center">
              <div className="relative group">
                {/* Gold glowing border */}
                <div className="absolute -inset-2 bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-700 rounded-3xl blur-md opacity-40 group-hover:opacity-60 transition duration-500" />

                <div className="relative rounded-2xl overflow-hidden border-2 border-cyan-400/60 shadow-2xl max-w-sm w-full bg-slate-900">
                  <img
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#071b34] via-[#071b34]/90 to-transparent p-5 text-white">
                    <h3 className="text-xl font-black text-cyan-300 tracking-wide uppercase">
                      {BRAND_INFO.ceo.name}
                    </h3>
              ...
              <div className="mt-6 w-full max-w-sm space-y-2 text-left bg-[#071b34]/90 p-4 rounded-2xl border border-cyan-400/20 text-xs">
                <a
                  href={`tel:${BRAND_INFO.contact.hotlineRaw}`}
                  className="flex items-center gap-3 text-cyan-400 hover:text-cyan-300 font-extrabold text-sm"
                >
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-3">
                <div className="text-cyan-400 font-extrabold text-sm uppercase tracking-wider flex items-center gap-2">
                ...
                <p className="text-cyan-200/90 text-sm italic font-medium">
              ...
              <div>
                <div className="text-cyan-400 font-extrabold text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-cyan-400" />
                  <span>LỢI ÍCH HỢP TÁC VÀNG:</span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-[#071b34]/90 p-4 rounded-2xl border border-slate-700/80 hover:border-cyan-400/50 transition-colors flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-cyan-400/20 text-cyan-400 flex items-center justify-center shrink-0 mt-0.5">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:from-cyan-300 hover:to-cyan-500 text-[#071b34] font-black text-sm rounded-2xl shadow-xl flex items-center justify-center gap-2 transform hover:-translate-y-0.5 transition-all"
                >
                ...
                <a
                  href={`tel:${BRAND_INFO.contact.hotlineRaw}`}
                  className="w-full sm:w-auto px-6 py-3.5 bg-slate-900 hover:bg-slate-800 text-cyan-400 border border-cyan-500/30 font-bold text-sm rounded-2xl flex items-center justify-center gap-2 transition-colors"
                >

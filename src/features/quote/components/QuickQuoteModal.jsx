      ...
      <div className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200 animate-in fade-in zoom-in-95">
        ...
        <div className="bg-[#071b34] text-white p-5 flex items-center justify-between border-b border-cyan-500/20">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-cyan-200/80">HUNI UNIFORM • Phản hồi chỉ trong 5 phút</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-slate-800 font-medium focus:outline-none focus:border-cyan-500"
              >
            ...
            <div className="space-y-3 pt-1">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:border-cyan-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-cyan-500"
                />
              </div>
            </div>

            {/* Guarantees */}
            <div className="p-3 bg-cyan-50 rounded-xl border border-cyan-200 text-cyan-900 text-[11px] space-y-1">
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:from-cyan-300 hover:to-cyan-500 text-[#071b34] font-black text-xs sm:text-sm rounded-xl shadow-lg flex items-center justify-center gap-2 transform hover:-translate-y-0.5 transition-all"
            >
          ...
          <div className="p-8 text-center space-y-4">
            ...
            <button
              onClick={handleClose}
              className="px-6 py-2.5 bg-[#071b34] text-cyan-300 font-bold text-xs rounded-xl"
            >
              Đóng cửa sổ
            </button>
          </div>

...
export default function ProductCard({ product }) {
  ...
  return (
    <div
      ...
      className="group bg-white rounded-2xl border border-slate-200 hover:border-cyan-400/80 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col cursor-pointer relative"
    >
      {/* Product Image Area */}
      <div className="relative h-64 sm:h-72 w-full overflow-hidden bg-slate-100">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5 items-start">
          {product.badge && (
            <span className="px-2.5 py-1 rounded-full bg-[#071b34] text-cyan-300 font-bold text-[11px] shadow-md border border-cyan-400/40">
              {product.badge}
            </span>
          )}
        ...
        <div className="absolute bottom-3 left-3 right-3 flex items-center gap-2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
          ...
          <button
            ...
            className="py-2 px-3 bg-cyan-500 hover:bg-cyan-400 text-[#071b34] text-xs font-extrabold rounded-xl shadow-lg flex items-center justify-center gap-1 transition-colors"
          >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          {/* Title */}
          <h3 className="font-bold text-[#071b34] text-sm sm:text-base leading-snug group-hover:text-cyan-700 transition-colors line-clamp-2">
            {product.title}
          </h3>
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
          ...
          <button
            ...
            className="w-10 h-10 rounded-xl bg-slate-900 hover:bg-cyan-500 text-cyan-400 hover:text-[#071b34] flex items-center justify-center shadow-md transition-colors"
          >
